...
def match_tuples(origin_data, watermarked_data, indices):
    ...
    # 选择 MSBs 的 k 个属性作为主键
    primary_key_cols = ['Elevation', 'Aspect', 'Slope']  # 选择 'Elevation' 和 'Aspect' 作为主键
...
for proportion in proportions:
    ...
    for seed in range(10000, 10001):
        ...
        watermarked_data = pd.read_csv(f"/home/zhengyihao/TabularMark/datasets/covertype/deletion/covertype-{seed}-{proportion}-0.csv")
        ...
        z_score = (green_cell - num_match_indices/2) / math.sqrt(num_match_indices/4)
